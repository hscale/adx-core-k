  ...
  plugins: [
    ...
    federation({
      ...
      exposes: {
        ...
        './TenantInvitation': './src/components/TenantInvitation.tsx',
        './TenantMembership': './src/components/TenantMembership.tsx',
        './TenantProvider': './src/providers/TenantProvider.tsx',
      },
      shared: {
        react: { 
          singleton: true,
